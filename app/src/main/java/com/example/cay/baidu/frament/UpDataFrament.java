...
public class UpDataFrament extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        ((TextView) view.findViewById(R.id.tv_type_name)).setText("当前集数：");
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        ...
        mSubmit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(final View v) {
                ...
                HttpUtils.getInstance().upMovieDetails().updataNowNum(id,mNowBum.getText().toString().trim())
                        .subscribeOn(Schedulers.io())
                        .observeOn(AndroidSchedulers.mainThread())
                        .subscribe(new Observer<UpMovieBackResult>() {
                            @Override
